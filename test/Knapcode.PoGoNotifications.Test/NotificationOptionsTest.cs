        ...
        public static IEnumerable<object[]> IgnoredPokemonData
        {
            get
            {
                return new object[][]
                {
                    ...
                    new object[] { 25,  "Pikachu",    true,  true  },
                    new object[] { 26,  "Raichu",     true,  true  },
                    new object[] { 27,  "Sandshrew",  false, false },
                    new object[] { 28,  "Sandslash",  false, false },
                    new object[] { 29,  "Nidoran♀",  true,  true  },
                    new object[] { 30,  "Nidorina",   true,  true  },
                    new object[] { 31,  "Nidoqueen",  true,  true  },
                    new object[] { 32,  "Nidoran♂",  true,  true  },
                    new object[] { 33,  "Nidorino",   true,  true  },
                    new object[] { 34,  "Nidoking",   true,  true  },
                    new object[] { 35,  "Clefairy",   true,  true  },
                    new object[] { 36,  "Clefable",   true,  true  },
                    new object[] { 37,  "Vulpix",     true,  true  },
                    new object[] { 38,  "Ninetales",  true,  true  },
                    new object[] { 39,  "Jigglypuff", true,  true  },
                    new object[] { 40,  "Wigglytuff", true,  true  },
                    new object[] { 41,  "Zubat",      true,  true  },
                    new object[] { 42,  "Golbat",     true,  true  },
                    new object[] { 43,  "Oddish",     true,  true  },
                    new object[] { 44,  "Gloom",      true,  true  },
                    new object[] { 45,  "Vileplume",  true,  true  },
                    ...
                    new object[] { 50,  "Diglett",    true,  true  },
                    new object[] { 51,  "Dugtrio",    true,  true  },
                    new object[] { 52,  "Meowth",     true,  true  },
                    new object[] { 53,  "Persian",    true,  true  },
                    new object[] { 54,  "Psyduck",    true,  true  },
                    new object[] { 55,  "Golduck",    true,  true  },
                    new object[] { 56,  "Mankey",     true,  true  },
                    new object[] { 57,  "Primeape",   true,  true  },
                    new object[] { 58,  "Growlithe",  true,  true  },
                    new object[] { 59,  "Arcanine",   true,  true  },
                    new object[] { 60,  "Poliwag",    true,  true  },
                    new object[] { 61,  "Poliwhirl",  true,  true  },
                    new object[] { 62,  "Poliwrath",  true,  true  },
                    new object[] { 63,  "Abra",       true,  true  },
                    new object[] { 64,  "Kadabra",    true,  true  },
                    new object[] { 65,  "Alakazam",   true,  true  },
                    new object[] { 66,  "Machop",     true,  true  },
                    new object[] { 67,  "Machoke",    true,  true  },
                    new object[] { 68,  "Machamp",    true,  true  },
                    ...
                    new object[] { 73,  "Tentacruel", true,  true  },
                    new object[] { 74,  "Geodude",    true,  true  },
                    new object[] { 75,  "Graveler",   true,  true  },
                    new object[] { 76,  "Golem",      true,  true  },
                    new object[] { 77,  "Ponyta",     true,  true  },
                    new object[] { 78,  "Rapidash",   true,  true  },
                    new object[] { 79,  "Slowpoke",   true,  true  },
                    new object[] { 80,  "Slowbro",    true,  true  },
                    new object[] { 81,  "Magnemite",  true,  true  },
                    new object[] { 82,  "Magneton",   true,  true  },
                    new object[] { 83,  "Farfetch'd", false, false },
                    new object[] { 84,  "Doduo",      true,  true  },
                    new object[] { 85,  "Dodrio",     true,  true },
                    new object[] { 86,  "Seel",       true,  true  },
                    new object[] { 87,  "Dewgong",    true,  true  },
                    new object[] { 88,  "Grimer",     false, false },
                    ...
                    new object[] { 94,  "Gengar",     true,  true  },
                    new object[] { 95,  "Onix",       false, false },
                    ...
                    new object[] { 100, "Voltorb",    true,  true  },
                    new object[] { 101, "Electrode",  true,  true  },
                    new object[] { 102, "Exeggcute",  true,  true  },
                    new object[] { 103, "Exeggutor",  true,  true  },
                    new object[] { 104, "Cubone",     true,  true  },
                    new object[] { 105, "Marowak",    true,  true  },
                    new object[] { 106, "Hitmonlee",  true,  true  },
                    new object[] { 107, "Hitmonchan", false, false },
                    new object[] { 108, "Lickitung",  true,  true  },
                    new object[] { 109, "Koffing",    true,  true  },
                    new object[] { 110, "Weezing",    true,  true  },
                    new object[] { 111, "Rhyhorn",    true,  true  },
                    new object[] { 112, "Rhydon",     true,  true  },
                    ...
                    new object[] { 134, "Vaporeon",   true,  true  },
                    new object[] { 135, "Jolteon",    true,  true  },
                    new object[] { 136, "Flareon",    true,  true  },
                    ...
                    new object[] { 147, "Dratini",    false, false },
                    new object[] { 148, "Dragonair",  false, false },
